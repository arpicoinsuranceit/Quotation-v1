...
@Document(collection = "inratecardarprelief") 
public class RateCardARP {

	@Id
    private String id;
    private Integer age;
    private Integer term;
    private String rlfterm;
    private Double rate;
    private Date strdat;
    private Date enddat;
	...
	public String getRlfterm() {
		return rlfterm;
	}

	public void setRlfterm(String rlfterm) {
		this.rlfterm = rlfterm;
	}
