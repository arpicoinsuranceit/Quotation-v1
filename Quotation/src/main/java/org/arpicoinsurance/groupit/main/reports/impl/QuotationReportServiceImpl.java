...
public class QuotationReportServiceImpl implements QuotationReportService {
	...
	public String createAIPReport(QuotationDetails quotationDetails, QuotationView quotationView, QuoCustomer quoCustomer) throws Exception {
		...
		File file = new File(DEST+"INVP/"+quotationDetails.getQdId().toString()+".pdf");
	        ...
	        agcell2.add(new Paragraph(": "+date).setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        ...
	        agCell3.add(new Paragraph("Branch Name").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        agtTable.addCell(agCell3);
	        Cell agcell4 = new Cell();
	        agcell4.setBorder(Border.NO_BORDER);
	        agcell4.add(new Paragraph(quotationDetails.getQuotation().getUser().getBranch().getBranch_Name()!=null ? ": "+quotationDetails.getQuotation().getUser().getBranch().getBranch_Name() : ": ").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        ...
	        agCell5.add(new Paragraph("Agent Name").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        agtTable.addCell(agCell5);
	        Cell agcell6 = new Cell();
	        agcell6.setBorder(Border.NO_BORDER);
	        agcell6.add(new Paragraph(quotationDetails.getQuotation().getUser().getUser_Name()!=null ? ": "+quotationDetails.getQuotation().getUser().getUser_Name() : ": ").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        ...
	        agcell7.add(new Paragraph("Agent Code").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        agtTable.addCell(agcell7);
	        Cell agcell8 = new Cell();
	        agcell8.setBorder(Border.NO_BORDER);
	        agcell8.add(new Paragraph(quotationDetails.getQuotation().getUser().getUser_Code()!=null ? ": "+quotationDetails.getQuotation().getUser().getUser_Code() : ": ").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        ...
	        agcell9.add(new Paragraph("Contact No").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        agtTable.addCell(agcell9);
	        
	        Cell agCell10 = new Cell();
	        agCell10.setBorder(Border.NO_BORDER);
        	agCell10.add(new Paragraph(quotationDetails.getQuotation().getUser().getUser_Mobile()!=null ? ": "+quotationDetails.getQuotation().getUser().getUser_Mobile() : ": ").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        ...
	        cuCell2.add(new Paragraph(quotationDetails.getCustomerDetails().getCustName()!=null ? ": "+quotationDetails.getCustomerDetails().getCustName() : ": ").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        ...
	        cucell3.add(new Paragraph("Age Next Birthday").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        cusTable.addCell(cucell3);
	        Cell cuCell4 = new Cell();
	        cuCell4.setBorder(Border.NO_BORDER);
	        if(quoCustomer.getMainLifeAge()!=null) {
		        cuCell4.add(new Paragraph(": "+quoCustomer.getMainLifeAge()).setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        }else {
	        ...
	        cucell5.add(new Paragraph("Occupation").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        cusTable.addCell(cucell5);
	        Cell cuCell6 = new Cell();
	        cuCell6.setBorder(Border.NO_BORDER);
	        cuCell6.add(new Paragraph(quotationDetails.getCustomerDetails().getOccupation().getOcupationName()!=null ? ": "+quotationDetails.getCustomerDetails().getOccupation().getOcupationName() : ": " ).setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        ...
	        if(quotationDetails.getPolTerm()!=null) {
	        	dlcell2.add(new Paragraph(": " + Integer.toString(quotationDetails.getPolTerm())).setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        }else {
	        ...
	        if(quotationDetails.getPayMode()!=null) {
	        	if(quotationDetails.getPayMode().equalsIgnoreCase("M")) {
	    	        dlcell4.add(new Paragraph(": Monthly Premium").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));

	        	}else if (quotationDetails.getPayMode().equalsIgnoreCase("Y")) {
	    	        dlcell4.add(new Paragraph(": Yearly Premium").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));

				}else if (quotationDetails.getPayMode().equalsIgnoreCase("Q")) {
	    	        dlcell4.add(new Paragraph(": Quarterly Premium").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));

				}else if (quotationDetails.getPayMode().equalsIgnoreCase("H")) {
	    	        dlcell4.add(new Paragraph(": Half Yearly Premium").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));

				}else if (quotationDetails.getPayMode().equalsIgnoreCase("S")) {
	    	        dlcell4.add(new Paragraph(": Single Premium").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        ...
	        dlcell5.add(new Paragraph("Mode Premium").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        DtlTable.addCell(dlcell5);
	        Cell dlcell6 = new Cell();
	        dlcell6.setBorder(Border.NO_BORDER);
	        if(quoCustomer.getModePremium()!=null) {
	        	dlcell6.add(new Paragraph(": " + Double.toString(quoCustomer.getModePremium())).setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        }else {
	        ...
	        dlcell7.add(new Paragraph("Policy Fees").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        DtlTable.addCell(dlcell7);
	        Cell dlcell8 = new Cell();
	        dlcell8.setBorder(Border.NO_BORDER);
	        if(quotationDetails.getPolicyFee()!=null) {
	        	dlcell8.add(new Paragraph(": "+Double.toString(quotationDetails.getPolicyFee())).setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        ...
	        dlcell9.add(new Paragraph("Total Premium").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        DtlTable.addCell(dlcell9);
	        Cell dlcell10 = new Cell();
	        dlcell10.setBorder(Border.NO_BORDER);
	        if(quoCustomer.getTotPremium()!=null) {
	        	dlcell10.add(new Paragraph(": " +Double.toString(quoCustomer.getTotPremium())).setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        }else {
	        ...
	        Cell cell1 = new Cell();
	        cell1.setHeight(12);
	        cell1.add(new Paragraph("Living Benefits").setFontSize(9).setBold().setTextAlignment(TextAlignment.CENTER).setCharacterSpacing(1));
	        benLivTable.addCell(cell1);           
	        Cell cell2 = new Cell();
	        cell1.setHeight(12);
	        cell2.add(new Paragraph("Amount").setFontSize(9).setBold().setTextAlignment(TextAlignment.CENTER).setCharacterSpacing(1));
	        ...
	        if(quotationView.getMainLifeBenf()!=null) {
	        	  ...
	        	  for (QuoBenf quoBenf : benefitsLife) {
	  	        	...
	  	        	Cell cell3 = new Cell();
	  		        cell3.add(new Paragraph(quoBenf.getBenfName()!=null ? quoBenf.getBenfName() : "").setFontSize(9).setTextAlignment(TextAlignment.LEFT));
	  		        benLivTable.addCell(cell3);           
	  		        Cell cell4 = new Cell();
	  		        cell4.setHeight(12);
	  		        if(quoBenf.getRiderSum()!=null) {
	  			        cell4.add(new Paragraph(Double.toString(quoBenf.getRiderSum())).setFontSize(9).setTextAlignment(TextAlignment.RIGHT));
	        ...
	        float [] pointColumnWidths4 = {300, 500};
	     	...
	     	abCell1.add(new Paragraph("Additional Benefits").setFontSize(9).setBold().setTextAlignment(TextAlignment.CENTER).setCharacterSpacing(1));
	     	...
	     	abCell3.add(new Paragraph("Twice the value of premium paid or account balance which ever is higher").setFontSize(9).setTextAlignment(TextAlignment.LEFT));
	     	...
	     	abCell5.add(new Paragraph("Account balance or 125% of the premium paid, which ever is higher").setFontSize(9).setTextAlignment(TextAlignment.LEFT));
	...
	public String createINVPReport(QuotationDetails quotationDetails, QuotationView quotationView, QuoCustomer quoCustomer) throws Exception {
        ...
        if((quoCustomer.getSpouseName())!=null) {
            ...
            cucell7.add(new Paragraph("Name Of Spouse").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
            cusTable.addCell(cucell7);
            Cell cuCell8 = new Cell();
            cuCell8.setBorder(Border.NO_BORDER);
            cuCell8.add(new Paragraph(": " +quoCustomer.getSpouseName()).setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
        ...
        if((quoCustomer.getSpouseAge())!=null) {
            ...
            cucell9.add(new Paragraph("Age Next Birthday (Spouse)").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
            cusTable.addCell(cucell9);
            Cell cuCell10 = new Cell();
            cuCell10.setBorder(Border.NO_BORDER);
            cuCell10.add(new Paragraph(": " + Integer.toString(quoCustomer.getSpouseAge())).setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
        ...
        if((quoCustomer.getSpouseOccupation())!=null) {
            ...
            cucell11.add(new Paragraph("Occupation (Spouse)").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
            cusTable.addCell(cucell11);
            Cell cuCell12 = new Cell();
            cuCell12.setBorder(Border.NO_BORDER);
            cuCell12.add(new Paragraph(": " + quoCustomer.getSpouseOccupation()).setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
      ...
      //creating Quotation Details Tables
        ...
        benAddTable.addCell(abCell1); 
        Cell abCell2 = new Cell();
        abCell2.add(new Paragraph("Amount").setFontSize(9).setBold().setTextAlignment(TextAlignment.CENTER).setCharacterSpacing(1));
        benAddTable.addCell(abCell2); 
        Cell abCell3 = new Cell();
        abCell3.add(new Paragraph("Premium").setFontSize(9).setBold().setTextAlignment(TextAlignment.CENTER).setCharacterSpacing(1));
        benAddTable.addCell(abCell3); 
        
        benAddTable.startNewRow();
        
        Cell abCell4 = new Cell(0,3);
        abCell4.add(new Paragraph("Main Life").setFontSize(9).setBold().setTextAlignment(TextAlignment.CENTER).setCharacterSpacing(1));
        benAddTable.addCell(abCell4);
        ...
        for (QuoBenf quoBenf : benefitsLife) {
        	...
        	if(quoBenf.getBenfName()!=null) {
                ...
                abCell5.add(new Paragraph(quoBenf.getBenfName()).setFontSize(9).setTextAlignment(TextAlignment.LEFT));
         	    ...
         	    abCell6.add(new Paragraph(Double.toString(quoBenf.getRiderSum())).setFontSize(9).setTextAlignment(TextAlignment.RIGHT));
         	    benAddTable.addCell(abCell6);
         	    Cell abCell7 = new Cell();
         	    abCell7.add(new Paragraph(Double.toString(quoBenf.getPremium())).setFontSize(9).setTextAlignment(TextAlignment.RIGHT));
	    ...
	    abCell8.add(new Paragraph("Spouse").setFontSize(9).setBold().setTextAlignment(TextAlignment.CENTER).setCharacterSpacing(1));
        ...
        for (QuoBenf quoBenf  : benefitsSpouse) {
        	...
        	if(quoBenf.getBenfName()!=null) {
        	    ...
        	    abCell10.add(new Paragraph(Double.toString(quoBenf.getRiderSum())).setFontSize(9).setTextAlignment(TextAlignment.RIGHT));
        	    benAddTable.addCell(abCell10);
        	    Cell abCell11 = new Cell();
        	    abCell11.add(new Paragraph(Double.toString(quoBenf.getPremium())).setFontSize(9).setTextAlignment(TextAlignment.RIGHT));
	    ...
	    abCell12.add(new Paragraph("Children").setFontSize(9).setBold().setTextAlignment(TextAlignment.CENTER).setCharacterSpacing(1));
        ...
        for (QuoChildBenef quoChild : benefitsChild) {
        	...
        	if(quoChild.getChild().getChildName()!=null) {
        	    ...
        	    abCell13.add(new Paragraph("Name : "+quoChild.getChild().getChildName()+ " Relationship : "+quoChild.getChild().getChildRelation()).setFontSize(9).setBold().setTextAlignment(TextAlignment.LEFT).setCharacterSpacing(1));
        	    ...
        	    benAddTable.startNewRow();
        	    	...
        	    	//loop again to get children benf
        	         for (QuoChildBenef quoChildBenef : benefitsChild) {
        	             ...
        	             abCell14.add(new Paragraph(quoChildBenef.getBenfs().get(0).getBenfName()).setFontSize(9).setTextAlignment(TextAlignment.LEFT));
        	             benAddTable.addCell(abCell14);
        	             Cell abCell15 = new Cell();
        	             abCell15.add(new Paragraph(Double.toString(quoChildBenef.getBenfs().get(0).getRiderSum())).setFontSize(9).setTextAlignment(TextAlignment.RIGHT));
        	             benAddTable.addCell(abCell15);
        	             Cell abCell16 = new Cell();
        	             abCell16.add(new Paragraph(Double.toString(quoChild.getBenfs().get(0).getPremium())).setFontSize(9).setTextAlignment(TextAlignment.RIGHT));
        ...
        list.setFontSize(10);
        ListItem item1 = new ListItem();
        item1.add(new Paragraph("If HRB / SUHRB is obtained, the total cover will be applicable for the whole family per policy year.").setFontSize(10).setFixedLeading(2));
        list.add(item1);
        
        ListItem item2 = new ListItem();
        item2.add(new Paragraph("Premiums are on standard rates and could defer on life risk: Medical, Occupational etc.").setFontSize(10).setFixedLeading(2));
        list.add(item2);
        
        ListItem item3 = new ListItem();
        item3.add(new Paragraph("This is an indicative quoteonly and is valid for 30 days from date issue.").setFontSize(10).setFixedLeading(2));
        list.add(item3);
        ...
        item5.add(new Paragraph("In event of death by accident both Accident Cover and Natural Death Cover will be applicable.").setFontSize(10).setFixedLeading(2));
        list.add(item5);
        
        ListItem item6 = new ListItem();
        item6.add(new Paragraph("Guranteed minimum dividend rate declared for 2016 - 7.25%").setFontSize(10).setFixedLeading(2));
        list.add(item6);
	...
	public String createDTAReport(QuotationDetails quotationDetails, QuotationView quotationView, QuoCustomer quoCustomer) throws Exception {
        ...
        document.add(cusTable);
          ...
          //creating Quotation Details Tables
            ...
            Cell dlcell1 = new Cell();
            dlcell1.setBorder(Border.NO_BORDER);
            dlcell1.add(new Paragraph("Interest Rate").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
            DtlTable.addCell(dlcell1);
            Cell dlcell2 = new Cell();
            dlcell2.setBorder(Border.NO_BORDER);
            if(quotationDetails.getInterestRate()!=null) {
            	dlcell2.add(new Paragraph(": " +Double.toString(quotationDetails.getInterestRate())).setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
            ...
            Cell dlcell3 = new Cell();
            dlcell3.setBorder(Border.NO_BORDER);
            dlcell3.add(new Paragraph("Loan Amount").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
            DtlTable.addCell(dlcell3);
            Cell dlcell4 = new Cell();
            dlcell4.setBorder(Border.NO_BORDER);
            if(quotationDetails.getBaseSum()!=null) {
            	dlcell4.add(new Paragraph(": " +Double.toString(quotationDetails.getBaseSum())).setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        ...
	        dlcell6.setBorder(Border.NO_BORDER);
	        if(quotationDetails.getPolTerm()!=null) {
	        	dlcell6.add(new Paragraph(": " + Integer.toString(quotationDetails.getPolTerm())).setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        }else {
	        	dlcell2.add(new Paragraph(": ").setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        }
	        DtlTable.addCell(dlcell6);
	        ...
	        if(quotationDetails.getPayMode()!=null) {
	        	if(quotationDetails.getPayMode().equalsIgnoreCase("M")) {
	        		dlcell8.add(new Paragraph(": Monthly Premium").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));

	        	}else if (quotationDetails.getPayMode().equalsIgnoreCase("Y")) {
	        		dlcell8.add(new Paragraph(": Yearly Premium").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));

				}else if (quotationDetails.getPayMode().equalsIgnoreCase("Q")) {
					dlcell8.add(new Paragraph(": Quarterly Premium").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));

				}else if (quotationDetails.getPayMode().equalsIgnoreCase("H")) {
					dlcell8.add(new Paragraph(": Half Yearly Premium").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));

				}else if (quotationDetails.getPayMode().equalsIgnoreCase("S")) {
					dlcell8.add(new Paragraph(": Single Premium").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        ...
	        Cell dlcell9 = new Cell();
	        dlcell9.setBorder(Border.NO_BORDER);
	        dlcell9.add(new Paragraph("Mode Premium").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        DtlTable.addCell(dlcell9);
	        Cell dlcell10 = new Cell();
	        dlcell10.setBorder(Border.NO_BORDER);
	        if(quoCustomer.getModePremium()!=null) {
	        	dlcell10.add(new Paragraph(": " + Double.toString(quoCustomer.getModePremium())).setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	        }else {
	        	dlcell10.add(new Paragraph("").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
	    ...
	    Cell abCell6 = new Cell();
	    if(quotationDetails.getBaseSum()!=null) {
		    abCell6.add(new Paragraph(Double.toString(quotationDetails.getBaseSum())).setFontSize(9).setTextAlignment(TextAlignment.RIGHT));
	    ...
	    if(quoCustomer.getMode().equalsIgnoreCase("Q")) {
	    	if(quotationDetails.getPremiumMonth()!=null) {
			    abCell7.add(new Paragraph(Double.toString(quotationDetails.getPremiumQuater())).setFontSize(9).setTextAlignment(TextAlignment.RIGHT));
	    	}else {
	    		
	    	}
	    }else if (quoCustomer.getMode().equalsIgnoreCase("M")) {
	    	if(quotationDetails.getPremiumMonth()!=null) {
			    abCell7.add(new Paragraph(Double.toString(quotationDetails.getPremiumMonth())).setFontSize(9).setTextAlignment(TextAlignment.RIGHT));
	    	}else {
	    	
	    	}
		}else if (quoCustomer.getMode().equalsIgnoreCase("Y")) {
			if(quotationDetails.getPremiumYear()!=null) {
			    abCell7.add(new Paragraph(Double.toString(quotationDetails.getPremiumYear())).setFontSize(9).setTextAlignment(TextAlignment.RIGHT));
	    	}else {
	    	
	    	}
		}else if (quoCustomer.getMode().equalsIgnoreCase("S")) {
			if(quotationDetails.getPremiumSingle()!=null) {
			    abCell7.add(new Paragraph(Double.toString(quotationDetails.getPremiumSingle())).setFontSize(9).setTextAlignment(TextAlignment.RIGHT));
	    	}else {

	    	}
		}else if (quoCustomer.getMode().equalsIgnoreCase("H")) {
			if(quotationDetails.getPremiumHalf()!=null) {
			    abCell7.add(new Paragraph(Double.toString(quotationDetails.getPremiumHalf())).setFontSize(9).setTextAlignment(TextAlignment.RIGHT));
	    	}else {
        ...
        benAddTable.startNewRow();
            ...
            if(quoBenf.getBenfName()!=null) {
      	    ...
      	    Cell abCell9 = new Cell();
      	    if(quoBenf.getRiderSum()!=null) {
          	    abCell9.add(new Paragraph(Double.toString(quoBenf.getRiderSum())).setFontSize(9).setTextAlignment(TextAlignment.RIGHT));
      	    }else {
      	    ...
      	    if(quoBenf.getPremium()!=null) {
          	    abCell10.add(new Paragraph(Double.toString(quoBenf.getPremium())).setFontSize(9).setTextAlignment(TextAlignment.RIGHT));
      	    }else {
        ...
        sdCell1.add(new Paragraph("Year").setFontSize(9).setBold().setTextAlignment(TextAlignment.CENTER).setCharacterSpacing(1));
        scdTable.addCell(sdCell1);
        Cell sdCell2 = new Cell();
        sdCell2.add(new Paragraph("Loan Balance").setFontSize(9).setBold().setTextAlignment(TextAlignment.CENTER).setCharacterSpacing(1));
        scdTable.addCell(sdCell2);
        Cell sdCell3 = new Cell();
        sdCell3.add(new Paragraph("Loan Protection").setFontSize(9).setBold().setTextAlignment(TextAlignment.CENTER).setCharacterSpacing(1));
        ...
        for (Shedule polShdl : shedules) {
        	...
        	if(polShdl.getPolicyYear()!=null) {
                sdCell4.add(new Paragraph(Integer.toString(polShdl.getPolicyYear())).setFontSize(9).setTextAlignment(TextAlignment.LEFT));
        	}else {
            ...
            if(polShdl.getOutSum()!=null) {
                sdCell5.add(new Paragraph(Double.toString(polShdl.getOutSum())).setFontSize(9).setTextAlignment(TextAlignment.RIGHT));
            }else {
            ...
            if(polShdl.getLorned()!=null) {
                sdCell6.add(new Paragraph(Double.toString(polShdl.getLorned())).setFontSize(9).setTextAlignment(TextAlignment.RIGHT));
            }else {
        ...
        ListItem item5 = new ListItem();
        item5.add(new Paragraph("Initial policy processing fee of Rs.450 (Payable only with initial deposit).").setFontSize(10).setFixedLeading(2));
        list.add(item5);
        
        ListItem item6 = new ListItem();
        item6.add(new Paragraph("In event of death by accident both Accident Cover and Natural Death Cover will be applicable.").setFontSize(10).setFixedLeading(2));
        list.add(item6);
	...
	public String createATRMReport(QuotationDetails quotationDetails, QuotationView quotationView, QuoCustomer quoCustomer) throws Exception {
      ...
      //creating Quotation Details Tables
        ...
        ListItem item5 = new ListItem();
        item5.add(new Paragraph("Initial policy processing fee of Rs. 300 (Payable only with initial deposit).").setFontSize(10).setFixedLeading(2));
        list.add(item5);
	...
	public String createASFPReport(QuotationDetails quotationDetails, QuotationView quotationView, QuoCustomer quoCustomer) throws Exception {
      ...
      //creating Quotation Details Tables
        ...
        ListItem item3 = new ListItem();
        item3.add(new Paragraph("This is an indicative quoteonly and is valid for 30 days from date of issue.").setFontSize(10).setFixedLeading(2));
        list.add(item3);
        ...
        ListItem item5 = new ListItem();
        item5.add(new Paragraph("This is only a Quotation and not an Acceptance of Risk.").setFontSize(10).setFixedLeading(2));
        list.add(item5);
        
        ListItem item6 = new ListItem();
        item6.add(new Paragraph("In the case of Death of the child and if no claim has been made on the primary benefit during the policy term, Total premium paid up to date on the Primary Benefit (MSFB) will be refundered.").setFontSize(10).setFixedLeading(10).setFixedLeading(10));
        list.add(item6);
        
        ListItem item7 = new ListItem();
        //item7.setFixedPosition(20, 50, 450);
        item7.add(new Paragraph("If no claim has been made on the primary benefit during the policy term, total premium paid on the Primary Benefit (MSFB) premium will be refundered at the policy expiry date.").setFontSize(10).setFixedLeading(10).setFixedLeading(10));
        list.add(item7);
	...
	public String createARPReport(QuotationDetails quotationDetails, QuotationView quotationView, QuoCustomer quoCustomer) throws Exception {
      ...
      //creating Quotation Details Tables
        ...
        Cell dlcell3 = new Cell();
        dlcell3.setBorder(Border.NO_BORDER);
        dlcell3.add(new Paragraph("Paying Term").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
        DtlTable.addCell(dlcell3);
        Cell dlcell4 = new Cell();
        dlcell4.setBorder(Border.NO_BORDER);
        if(quotationDetails.getPolTerm()!=null) {
        	dlcell4.add(new Paragraph(": "+(quotationDetails.getPaingTerm())).setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
        }else {
        ...
        if(quotationDetails.getPayMode()!=null) {
        	if(quotationDetails.getPayMode().equalsIgnoreCase("M")) {
        		dlcell6.add(new Paragraph(": Monthly Premium").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));

        	}else if (quotationDetails.getPayMode().equalsIgnoreCase("Y")) {
        		dlcell6.add(new Paragraph(": Yearly Premium").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));

			}else if (quotationDetails.getPayMode().equalsIgnoreCase("Q")) {
				dlcell6.add(new Paragraph(": Quarterly Premium").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));

			}else if (quotationDetails.getPayMode().equalsIgnoreCase("H")) {
				dlcell6.add(new Paragraph(": Half Yearly Premium").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));

			}else if (quotationDetails.getPayMode().equalsIgnoreCase("S")) {
				dlcell6.add(new Paragraph(": Single Premium").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
        ...
        Cell dlcell7 = new Cell();
        dlcell7.setBorder(Border.NO_BORDER);
        dlcell7.add(new Paragraph("Mode Premium").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
        DtlTable.addCell(dlcell7);
        Cell dlcell8 = new Cell();
        dlcell8.setBorder(Border.NO_BORDER);
        if(quoCustomer.getModePremium()!=null) {
        	dlcell8.add(new Paragraph(": " + Double.toString(quoCustomer.getModePremium())).setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
        }else {
        	dlcell8.add(new Paragraph("").setFontSize(10).setTextAlignment(TextAlignment.LEFT).setFixedLeading(10));
        ...
        psCell1.add(new Paragraph("Year").setFontSize(9).setBold().setTextAlignment(TextAlignment.CENTER).setCharacterSpacing(1));
    	polSmyTable.addCell(psCell1);
    	Cell psCell2 = new Cell(2, 0);
    	psCell2.add(new Paragraph("Premium per year for Basic Policy").setFontSize(9).setBold().setTextAlignment(TextAlignment.CENTER).setCharacterSpacing(1));
    	polSmyTable.addCell(psCell2);
    	Cell psCell3 = new Cell(2, 0);
    	psCell3.add(new Paragraph("Total Premium Paid per year").setFontSize(9).setBold().setTextAlignment(TextAlignment.CENTER).setCharacterSpacing(1));
    	polSmyTable.addCell(psCell3);
    	Cell psCell4 = new Cell(0, 2);
    	psCell4.add(new Paragraph("Minimum Life Benefits").setFontSize(9).setBold().setTextAlignment(TextAlignment.CENTER).setCharacterSpacing(1));
    	polSmyTable.addCell(psCell4);
    	
    	polSmyTable.startNewRow();
    	
    	Cell psCell5 = new Cell();
    	psCell5.add(new Paragraph("Protection against Natural Death").setFontSize(9).setBold().setTextAlignment(TextAlignment.CENTER).setCharacterSpacing(1));
    	polSmyTable.addCell(psCell5);
    	Cell psCell6 = new Cell();
    	psCell6.add(new Paragraph("Protection against Accident Death").setFontSize(9).setBold().setTextAlignment(TextAlignment.CENTER).setCharacterSpacing(1));
