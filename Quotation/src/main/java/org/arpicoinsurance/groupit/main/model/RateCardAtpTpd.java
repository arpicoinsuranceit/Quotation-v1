...
@Document(collection = "inratecardatptpd")
public class RateCardAtpTpd {
	...
	public String toString() {
		return "RateCardAtpTpd [id=" + id + ", term=" + term + ", rate=" + rate + ", strdat=" + strdat + ", enddat="
				+ enddat + ", creaby=" + creaby + ", creadt=" + creadt + "]";
	}
}
