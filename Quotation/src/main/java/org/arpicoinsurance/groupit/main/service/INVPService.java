...
public interface INVPService {
	...
	BigDecimal calculateL2(int ocu,int age, int term, double intrat, Date chedat, double bassum, int paytrm, QuotationQuickCalResponse calResponse, boolean isAddOccuLoading, double rebate)throws Exception;
	...
	HashMap<String, Object> editQuotation(QuotationCalculation calculation, InvpSaveQuotation _invpSaveQuotation,Integer userId,Integer qdId, Integer type) throws Exception;
