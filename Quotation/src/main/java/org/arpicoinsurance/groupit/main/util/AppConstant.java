...
public class AppConstant {
	...
	public final static String URL_GET_CANCELED_PRP = "http://localhost:8088/code_transfer/getCanceledCodeTransfersPrp";
	public final static String URL_GET_CANCELED_POL = "http://localhost:8088/code_transfer/getCanceledCodeTransfersPol";
	public final static String URL_GET_CODE_PENDING_PRP = "http://localhost:8088/code_transfer/getCodePendingProposalDetails";
	public final static String URL_GET_CODE_SAVE_PRP = "http://localhost:8088/code_transfer/saveCodeTranPrp";
