...
public class TPDASBSServiceImpl implements TPDASBSService {
	...
	@Override
	public BigDecimal calculateTPDASBS(int age, int term, Date chedat, double ridsumasu, String payFrequency,
		...
		try {
			if (payFrequency.equalsIgnoreCase("S")) {
				...
				premiumTPDASBS = ((new BigDecimal(rateCardTPDASB.getRate()).multiply(new BigDecimal(ridsumasu)))
