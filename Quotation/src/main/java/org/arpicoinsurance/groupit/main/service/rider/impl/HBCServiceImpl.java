...
public class HBCServiceImpl implements HBCService {
	...
	@Override
	public BigDecimal calculateHBC(Integer term, Date chedat, Double ridsumasu, String payFrequency, Double relief)
			throws Exception {
		...
		try {
			if (payFrequency.equalsIgnoreCase("S")) {
				...
				premiumHBC = (new BigDecimal(rateCardHBC.getRate()).multiply(new BigDecimal(ridsumasu))
