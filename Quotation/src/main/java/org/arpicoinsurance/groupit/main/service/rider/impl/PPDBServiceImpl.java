...
public class PPDBServiceImpl implements PPDBService{
	...
	@Override
	public BigDecimal calculatePPDB(double ridsumasu, String payFrequency, double relief, Double atpRate) throws Exception {
//		//System.out.println("PPDB ridsumasu : "+ridsumasu+" payFrequency : "+payFrequency+" relief : "+relief);
		...
		premiumPPDB = premiumPPDB.multiply(new  BigDecimal(atpRate)).setScale(0, RoundingMode.HALF_UP);
