...
public class QuotationQuickCalResponse {
	...
	public String toString() {
		return "QuotationQuickCalResponse [basicSumAssured=" + basicSumAssured + ", extraOE=" + extraOE + ", addBenif="
				...
				+ withoutLoadingTot + ", bsaYearlyPremium=" + bsaYearlyPremium + ", l2=" + l2 + ", l2term=" + l2term
				+ ", l2Sum=" + l2Sum + ", yearlyL2Sum=" + yearlyL2Sum + ", at6=" + at6 + ", at8=" + at8 + ", at10="
				+ at10 + ", guaranteed=" + guaranteed + ", adb=" + adb + ", adbBsa=" + adbBsa + ", adbTerm=" + adbTerm
				...
				+ hrbicTerm + ", hrbfc=" + hrbfc + ", hrbfcBsa=" + hrbfcBsa + ", hrbfcTerm=" + hrbfcTerm + ", shcbi="
				+ shcbi + ", shcbiBsa=" + shcbiBsa + ", shcbiTerm=" + shcbiTerm + ", shcbic=" + shcbic + ", shcbicBsa="
				+ shcbicBsa + ", shcbicTerm=" + shcbicTerm + ", shcbis=" + shcbis + ", shcbisBsa=" + shcbisBsa
				+ ", shcbisTerm=" + shcbisTerm + ", shcbf=" + shcbf + ", shcbfBsa=" + shcbfBsa + ", shcbfTerm="
				+ shcbfTerm + ", shcbfc=" + shcbfc + ", shcbfcBsa=" + shcbfcBsa + ", shcbfcTerm=" + shcbfcTerm
				+ ", shcbfs=" + shcbfs + ", shcbfsBsa=" + shcbfsBsa + ", shcbfsTerm=" + shcbfsTerm + ", dtaShedules="
				+ dtaShedules + ", isErrorExist=" + isErrorExist + ", error=" + error + ", isWarningExist="
